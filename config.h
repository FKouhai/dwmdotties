...
/* --------------- settings -------------- */
static const char *fonts[]      = { "JetBrainsMono Nerd Font:style=medium:size=10", "Hack Nerd Font:size=10" };
...
static Key keys[]               = {
	...
	{ MODKEY,                       XK_z,       reorganizetags, {0} },
	{ MODKEY|ShiftMask,             XK_z,       distributetags, {0} },
	...
	{ MODKEY,                       XK_r,       spawn,          SHCMD("rofi -combi-modi window,drun,ssh -font 'hack 10' -show combi") },
	{ MODKEY|ShiftMask,             XK_r,       spawn,          SHCMD("rofi -show p -font 'hack 10' -modi p:rofi-power-menu ") },
	{ MODKEY|ShiftMask,                       XK_m,    spawn,          SHCMD("pactl set-sink-mute @DEFAULT_SINK@ true") },
	{ MODKEY|ShiftMask,                       XK_plus,   spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +10%")   },
	{ MODKEY|ShiftMask,             XK_minus,       spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -10%") },
	{ MODKEY|ShiftMask,             XK_u,       spawn,          SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle") },
...
static Button buttons[]         = {
	...
	{ ClkStatusText,        0 ,             Button1,        draw_status2d,   {.i = 1} },
	{ ClkStatusText,        0 ,             Button2,        spawn,          {.i = 0} },
